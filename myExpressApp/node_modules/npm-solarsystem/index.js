...
module.exports.getMeteorite = function Meteorites() {
    const meteorites = {
        description: 'When meteoroids enter Earth’s atmosphere (or that of another planet, like Mars) at high speed and burn up, the fireballs or “shooting stars”<br>When a meteoroid survives a trip through the atmosphere and hits the ground<br>Several meteors per hour can usually be seen on any given night. When there are lots more meteors',
        // meteorShowers: '',
        // meteorite: '',
        websiteLink: 'https://solarsystem.nasa.gov/asteroids-comets-and-meteors/meteors-and-meteorites/in-depth/',
...
module.exports.getComets = function Comets() {
    const comets = {
        description: 'Comets are cosmic snowballs of frozen gases, rock and dust that orbit the Sun. When frozen, they are the size of a small town. When a comets orbit brings it close to the Sun, it heats up and spews dust and gases into a giant glowing head larger than most planets. The dust and gases form a tail that stretches away from the Sun for millions of miles. There are likely billions of comets orbiting our Sun in the Kuiper Belt and even more distant Oort Cloud.',
        websiteLink: 'https://solarsystem.nasa.gov/asteroids-comets-and-meteors/comets/overview/?page=0&per_page=40&order=name+asc&search=&condition_1=102%3Aparent_id&condition_2=comet%3Abody_type%3Ailike',
...
module.exports.getAsteroids = function Asteroids() {
    const asteroids = {
        description: 'Asteroids, sometimes called minor planets, are rocky, airless remnants left over from the early formation of our solar system about 4.6 billion years ago.',
        image: 'https://solarsystem.nasa.gov/system/news_items/main_images/786_bennu_dec10.jpg',
        websiteLink: 'https://solarsystem.nasa.gov/asteroids-comets-and-meteors/asteroids/overview/?page=0&per_page=40&order=name+asc&search=&condition_1=101%3Aparent_id&condition_2=asteroid%3Abody_type%3Ailike'
    }
